...
const SecCaptionMobile = (props: Props) => {
  ...
  return (
    <motion.div
      className="relative h-[180vh] w-full overflow-hidden bg-zinc-900 md:hidden"
      ref={targetRef}
    >
      <div className="relative h-full w-full">
        <div className="absolute left-1/2 top-[40%] z-50 -translate-x-1/2 -translate-y-1/2">
          {/* Caption */}
          <motion.div className="flex flex-col items-center justify-center font-bold text-yellow-400">
            {characters.map((char, i) => (
              <motion.div
                ...
                key={i}
                className="caption2 z-20 text-2xl font-bold md:text-7xl lg:text-8xl xl:text-9xl"
              >
                {char}
              </motion.div>
            ))}
        ...
        <div className="flex h-full w-full flex-col">
          ...
          >
            <motion.div className="relative h-full w-full">
              ...
              <div className="absolute left-[50%] top-[60%] -translate-x-1/2 -translate-y-1/2">
                <h1 className="w-full scale-y-150 text-end text-3xl font-bold text-yellow-400 opacity-40 md:text-7xl lg:text-9xl">
                  ABOUT US
                </h1>
              </div>
            </motion.div>
          ...
          {/* Right Side Content */}
          <motion.div className="h-full" style={{ opacity: contentOpacity }}>
...
export default SecCaptionMobile;
